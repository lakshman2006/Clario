...
const Footer = () => {
  ...
  const footerLinks = {
    product: [
      { name: 'Schedule Maker', path: '/schedule' },
      ...
      <div className="footer-content">
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              ...
              Create custom schedules and discover the best resources for your learning journey.
            </p>
          ...
          <div className="footer-links">
            ...
            <div className="link-column">
              <h3 className="link-title">Newsletter</h3>
              <p className="newsletter-text">
                Stay updated with learning tips and new features
              </p>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            <p>&copy; {currentYear} CLARIO. All rights reserved.</p>
          </div>
